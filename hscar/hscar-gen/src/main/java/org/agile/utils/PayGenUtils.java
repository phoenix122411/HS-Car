 ...
 * @author zhangmm
 */
public class PayGenUtils {
	
	public static List<String> getTemplates(){
		List<String> templates = new ArrayList<String>();
		templates.add("template/pay/Entity.java.vm");
		templates.add("template/pay/Dao.java.vm");
		templates.add("template/pay/Dao.xml.vm");
		templates.add("template/pay/DaoRedisApi.java.vm");
		templates.add("template/pay/DaoRedisImpl.java.vm");
		templates.add("template/pay/ServiceApi.java.vm");
		templates.add("template/pay/ServiceImpl.java.vm");
		templates.add("template/pay/Controller.java.vm");
		templates.add("template/pay/list.html.vm");
		templates.add("template/pay/list.js.vm");
		templates.add("template/pay/menu.sql.vm");
		return templates;
	}
	...
	public static String getFileName(String template, String className, String classname, String packageName){
		...
		if(template.contains("Dao.xml.vm")){
			return packagePath + "mapper" + File.separator + className + "Base_Dao.xml";
		}
		
		if(template.contains("DaoRedisApi.java.vm")){
			return packagePath + "redis_dao" + File.separator + "api" + File.separator + "I" + className + "RedisDao.java";
		}
		
		if(template.contains("DaoRedisImpl.java.vm")){
			return packagePath + "redis_dao" + File.separator + "impl" + File.separator + className + "RedisDao.java";
		}
